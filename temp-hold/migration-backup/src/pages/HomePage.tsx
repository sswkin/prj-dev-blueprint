              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <div className="relative">
                    <div className="h-12 w-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white">
                  ...
                  {!loading && (
                    user ? (
                      <>
                        ...
                        <Link to="/wizard" className="block text-muted-foreground hover:text-foreground">
                          Create Blueprint
                        </Link>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button asChild size="lg" className="text-lg px-8 py-6">
                    <Link to={user ? "/wizard" : "/signup"}>
                      {user ? "Create Blueprint" : "Get Started"}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">Your Blueprint Journey</h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">Create your account and complete the onboarding process</p>
                </div>
              </motion.div>
              ...
              >
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Define Project</h3>
                  <p className="text-muted-foreground">Use our wizard to describe your project requirements and goals</p>
                </div>
              </motion.div>
              ...
              >
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Generate Blueprint</h3>
                  <p className="text-muted-foreground">Our AI creates a comprehensive development blueprint</p>
                </div>
              </motion.div>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">Export your blueprint and begin development with confidence</p>
                </div>
              </motion.div>
            </div>
              ...
              <CardContent className="p-8 sm:p-12">
                <div className="text-center space-y-6">
                  <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                  >
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Transform Your Development Process?</h2>
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
                      Join thousands of developers who are building better software, faster with DevBlueprint AI.
                    </p>
                    <Button asChild size="lg" className="text-lg px-8 py-6 bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90">
                      <Link to={user ? "/wizard" : "/signup"}>
                        {user ? "Create Your First Blueprint" : "Start Your Free Trial"}
                        <ArrowRight className="ml-2 h-5 w-5" />
                      </Link>
                    </Button>
                  </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div>
                <div className="flex items-center space-x-3 mb-4">
                  <div className="relative">
                    <div className="h-10 w-10 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white">
