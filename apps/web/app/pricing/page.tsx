...
export const metadata: Metadata = {
  title: "Pricing",
  description: "Choose the perfect plan for your development project needs. Flexible pricing options for individuals, teams, and enterprises.",
};
...
const pricingTiers: PricingTier[] = [
  {
    name: "Starter",
    price: "Free",
    description: "Perfect for individual developers getting started with project planning",
    features: [
          ...
          <div className="mt-20 text-center">
            <div className="rounded-2xl border border-border bg-card p-8 sm:p-12">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Join thousands of developers who use BlueprintForDev to plan and execute their projects more effectively.
              </p>
