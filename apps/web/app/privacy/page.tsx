...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for BlueprintForDev - Learn how we collect, use, and protect your data.",
};
        ...
        <article className="prose prose-sm sm:prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              BlueprintForDev ("we," "us," "our," or "Company") is committed to
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
              ...
              <li>
                <strong>Cookies:</strong> Information stored on your device for
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
              <li>
                ...
                or if we believe in good faith that disclosure is necessary
              </li>
              <li>
              ...
              <li>
                ...
                transferred as part of a merger, acquisition, or sale of assets
              </li>
            </ul>
          </section>
