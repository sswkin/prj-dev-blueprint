...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for BlueprintForDev - Read our terms and conditions for using our service.",
};
        ...
        <article className="prose prose-sm sm:prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              entity ("you") and BlueprintForDev ("we," "us," "our," or
              "Company"), concerning your access to and use of the
              BlueprintForDev website and all related applications, services,
              tools, and materials.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              automatically grant us, and authorize us to sublicense to others,
              an unrestricted, unlimited, irrevocable, perpetual, non-exclusive,
              transferable, royalty-free, fully-paid, worldwide right to use,
              copy, reproduce, fix, adapt, modify, create derivative works from,
              make available, perform, send, transmit, display, publish,
              distribute, and sublicense the Contributions.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              make no warranties, expressed or implied, regarding the Site. To
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              In no event shall BlueprintForDev or its suppliers be liable for
              any damages (including, without limitation, damages for loss of
              data or profit, or due to business interruption) arising out of
              the use or inability to use the materials on BlueprintForDev's
              website.
            </p>
          </section>
