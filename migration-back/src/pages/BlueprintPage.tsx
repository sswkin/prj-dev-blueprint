...
// Types
import type { AIConcept, Tag, ScreenProps } from "@/components/types";
...
export default function BlueprintPage() {
  const [currentScreen, setCurrentScreen] =
    useState<ScreenName>("IDEA_CAPTURE");
  ...
  const handleIdeaAnalyze = useCallback(
    async (idea: string) => {
      setOriginalIdea(idea);
      const result = await execute<{ tags: Tag[]; concepts: AIConcept[] }>(
        "analyze",
      );
    ...
    () => [
      {
        ...
        status: completedScreens.has("IDEA_CAPTURE")
          ? "completed"
          : currentScreen === "IDEA_CAPTURE"
            ? "in-progress"
            : "pending",
        props: {
      ...
      },
      {
        ...
        status: completedScreens.has("VALIDATION")
          ? "completed"
      ...
      },
      {
        ...
        status: completedScreens.has("RESEARCH")
          ? "completed"
      ...
      },
      {
        ...
        status: completedScreens.has("ARCHITECTURE")
          ? "completed"
      ...
      },
      {
        ...
        status: completedScreens.has("COMPONENTS")
          ? "completed"
      ...
      },
      {
        ...
        status: completedScreens.has("DATABASE")
          ? "completed"
      ...
      },
      {
        ...
        status: completedScreens.has("EXPORT")
          ? "completed"
