    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Manage your BlueprintForDev AI subscription and billing preferences."
          />
        </Helmet>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {usageStats.blueprints_used} /{" "}
                        {usageStats.blueprints_limit}
                      </span>
                    </div>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Your invoices and payment history will appear here once you
