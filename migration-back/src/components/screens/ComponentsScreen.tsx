  ...
  <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50 to-rose-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-8">
    <div className="max-w-6xl mx-auto">
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <div className="w-1/4 p-3 bg-slate-100 dark:bg-slate-700 rounded">
                  Sidebar
                </div>
                <div className="flex-1 p-3 bg-slate-50 dark:bg-slate-800 rounded">
                  Main Content
                </div>
              </div>
              <div className="p-3 bg-slate-100 dark:bg-slate-700 rounded">
      ...
      <div className="flex justify-between mt-8">
        ...
        <Button onClick={onNext}>Next: Database Design</Button>
      </div>
    </div>
  </div>
);
