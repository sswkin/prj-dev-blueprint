  ...
  <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-8">
    <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="p-3 bg-slate-50 dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700">
                <div className="font-mono text-sm">
                  ...
                  <div className="ml-4">
                    id: <span className="text-blue-500">UUID</span> (PK)
                  </div>
                  <div className="ml-4">
                    email: <span className="text-blue-500">VARCHAR</span>{" "}
                    (UNIQUE)
                  </div>
                  <div className="ml-4">
                    password: <span className="text-blue-500">VARCHAR</span>
                  </div>
                  <div className="ml-4">
                    createdAt: <span className="text-blue-500">TIMESTAMP</span>
                  </div>
                </div>
              </div>
              <div className="p-3 bg-slate-50 dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700">
                <div className="font-mono text-sm">
                  ...
                  <div className="ml-4">
                    title: <span className="text-blue-500">VARCHAR</span>
                  </div>
                  <div className="ml-4">
                    content: <span className="text-blue-500">TEXT</span>
                  </div>
                  <div className="ml-4">
                    userId: <span className="text-blue-500">UUID</span> (FK)
                  </div>
                  <div className="ml-4">
                    createdAt: <span className="text-blue-500">TIMESTAMP</span>
                  </div>
      ...
      <div className="flex justify-between mt-8">
        ...
        <Button onClick={onNext}>Export Project</Button>
      </div>
    </div>
  </div>
);
